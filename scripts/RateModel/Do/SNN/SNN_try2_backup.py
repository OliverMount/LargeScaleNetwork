...
#plt.plot(True_rate[:,0],'r-')
#plt.plot(True_rate[:,1],'b-')
#plt.plot(True_rate[:,2],'k-')
#plt.show()
...
Lconn_path='/olive/Maths/R/Do/SNN/Results/LocalConn/'
Gloconn_path='/olive/Maths/R/Do/SNN/Results/GlobalConn/'
#-------------------------------------------------------------- 
