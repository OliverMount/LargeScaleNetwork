function Joptim=Balance_J_gain(we,C,gain)
...
% Here run a simle analytic formulation to be close to the actual value.
[J]=Balance_J_analytic(we,C,gain);
