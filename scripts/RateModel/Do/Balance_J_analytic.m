function [Joptim]=Balance_J_analytic(we,C,gain)
	...
	% keyboard
	functional=Jexti*I0 + JN*gamma*r_0*taon/(1+ gamma*r_0*taon) - taog*phii_gain(ii,gain) - ii;  % This is fine
...
% keyboard
	Joptim = sum(C)'*we*JN/(phii_gain(ii,gain)*taog)*(gamma*r_0*taon/(1+ taon*gamma*r_0)) + 1; % What is this?
