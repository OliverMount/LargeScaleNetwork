...
ax[0,0].plot(SE[1000:-2,0])
ax[0,1].plot(SE[1000:-2,1])
ax[0,2].plot(SE[1000:-2,20])
ax[1,0].plot(SE[1000:-2,50])
ax[1,1].plot(SE[1000:-2,120])
ax[1,2].plot(SE[1000:-2,220])
plt.show()

_,ax=plt.subplots(2,3,figsize=(20,5))
ax[0,0].plot(RE[1000:-2,0])
ax[0,1].plot(RE[1000:-2,1])
ax[0,2].plot(RE[1000:-2,20])
ax[1,0].plot(RE[1000:-2,50])
ax[1,1].plot(RE[1000:-2,120])
ax[1,2].plot(RE[1000:-2,220])
plt.show()



_,ax=plt.subplots(2,3,figsize=(20,5))
ax[0,0].plot(I_exc[1000:-2,0])
ax[0,1].plot(I_exc[1000:-2,1])
ax[0,2].plot(I_exc[1000:-2,20])
ax[1,0].plot(I_exc[1000:-2,50])
ax[1,1].plot(I_exc[1000:-2,120])
ax[1,2].plot(I_exc[1000:-2,220])
plt.show()
